...
community_matrix <- community_matrix_rough %>% 
  clean_names() 
  group_by(id) %>% 
  mutate(mytilus_sp = sum(mussel_na +
                      mussel_0_5cm +
                      mussel_2_5mm +
                      mussel_5mm +
                      mussel_large +
         ...
         amphibalanus_improvisus = sum(acorn_barnacle_na +
                              acorn_barnacle_intact),
         amphibalanus_amphitrite = barnacle_type_2_na,
         hiatella_sp = clam_na +
           clam_0_2cm,
         jassa_marmorata = c_f_jassa_na +
           c_f_jassa_heads +
           c_f_jassa_large +
           c_f_jassa_medium +
           c_f_jassa_small,
         austrominius_modestus = acorn_barnacle_ribbed_na +
           acorn_barnacle_ribbed_intact,
         carcinus_maenas = crab_na +
           crab_juvenile_na,
         membranipora_membranacea = encrusting_bryozoan_fragment +
           encrusting_bryozoan_na +
           encrusting_bryozoan_colony +
           encrusting_bryozoan_squares,
         tricellaria_inopinata_colony = white_tufted_bryozoan_colony +
           white_tufted_bryozoan_large_colony +
           white_tufted_bryozoan_small_colony +
           white_tufted_bryozoan_fragment +
           white_tufted_bryozoan_na +
           type_2_white_tufted_bryozoan_fragment,
         polychaete_tube_fragment = polychaete_tube_fragment +
           polychaete_tube_na,
         round_amphipod = round_amphipod_na +
           green_eye_amphipod_na,
         conchoderma_auritum = c_f_conchoderma_na,
         bugula_neritina = brown_bryozoan_fragment,
         monocorophium_sextonae = c_f_corophium_na,
         caprella_mutica = caprellid_na,
         hydroid = hydroid_squares +
           hydroid_colony,
         cryptosula_pallasiana = c_f_schizoporella_squares +
           c_f_schizoporella_na,
         electra_pilosa = spiked_encrusting_bryo_colony,
         clear_tunicates = mystery_tunicates_large_anemone_na,
         caprella_equilibra = c_f_caprella_equilibra_na,
         .keep = "unused") %>% 
  ungroup() %>% 
...
ggplot() +
  geom_bar(data = mean_density_stage,
           aes(x = stage, y = avg_density, fill = taxon),
           stat = "identity",
           position = "stack") +
